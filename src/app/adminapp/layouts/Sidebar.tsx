    ...
    <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-48 bg-white border-r border-gray-200 transform transition-transform duration-300 ${
      ...
      <div className="h-full flex flex-col">
        ...
        <nav className="flex-1 px-2 py-3 space-y-1 overflow-y-auto">
          <Link href="/adminapp" onClick={() => setSidebarOpen(false)} className={`w-full flex items-center gap-1.5 px-2 py-1.5 rounded-md transition-colors duration-200 ${isActive('/adminapp') ? 'text-blue-700 bg-blue-50' : 'text-gray-700 hover:bg-blue-500 hover:text-white'}`}>
